...
class ListBuilder extends CommonController {
    ...
    private $_select_search  = array();    // select搜索参数配置
    ...
    private $_top_extra_html;              // 顶部额外功能代码
     ...
     * @author jry <598821125@qq.com>
     */
    public function setSelectSearch($name,$title,$options = array()) {
        $this->_select_search = array('name'=>$name,'title' => $title, 'options'=>$options);
        return $this;
    }
    ...
    /**
     * 设置顶部额外功能代码
     * @param $top_extra_html 顶部额外功能代码
     * @return $this
     * @author bigfoot
     */
    public function setTopExtraHtml($top_extra_html) {
        $this->_top_extra_html = $top_extra_html;
        return $this;
    }
    /**
     * 设置页面模版
    ...
    public function display() {
                    ...
                    case 'status':
                        switch($data[$column['name']]){
                            ...
                            case '1':
                                ...
                                break;
                            case '2':
                                $data[$column['name']] = '<i class="fa fa-check text-success">激活</i>';
                                break;
                        }
                        break;
                    case 'username':
                        $data[$column['name']] = get_user_name($data[$column['name']]);
                        break;
                    case 'byte':
        ...
        $this->assign('select_search',       $this->_select_search);              // 搜索配置
