...
$_config = array(
     ...
     * 
     */
    'PRODUCT_NAME'    => 'bigfoot',                      // 产品名称
    'PRODUCT_LOGO'    => '<b><span class="open" style="color: #a5aeb4;">龙行天下</span><br/><span class="cmf" style="color: #3fa9f5;">营销系统</span></b>',  // 产品Logo
    'CURRENT_VERSION' => '1.3.0',                        // 当前版本号
    'DEVELOP_VERSION' => 'beta1',                        // 开发版本号
    'BUILD_VERSION'   => '201607201705',                 // 编译标记
    'PRODUCT_MODEL'   => 'bigfoot',                    // 产品型号
    ...
    'SMS_NOTICE_INDEX'    => APP_PATH.'Sms/View/Notice/index.html',
